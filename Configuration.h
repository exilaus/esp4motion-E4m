...
#define STRING_CONFIG_H_AUTHOR "(EXILAUS)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "EXI K1"
...
#define MANUAL_Z_HOME_POS 316 // Distance between the nozzle to printbed after homing
...
#define DEFAULT_MAX_FEEDRATE          {9000, 9000, 9000, 200}    // (mm/sec)
